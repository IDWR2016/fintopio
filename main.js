  ...
  async startFarming(token) {
    ...
    try {
      ...
      if (finishTimestamp) {
        ...
        this.log(`Farm Dimulai...`, "yellow");
        this.log(`Farming Waktu: ${finishTime}`, "green");
      } else {
        this.log("Tidak ada waktu penyelesaian yang tersedia.", "yellow");
      }
    } catch (error) {
      this.log(`Kesalahan Start farming: ${error.message}`, "red");
    }
  }
  ...
  async main() {
    ...
    while (true) {
      ...
      for (let i = 0; i < users.length; i++) {
        ...
        if (token) {
          this.log(`Login Sukses Abangku!`, "green");
          this.log(`Support Terus IDWR!`, "green");
